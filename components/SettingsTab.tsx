...
const SocialLink: React.FC<{ platform: string, url:string, handle: string, icon: React.ReactNode }> = ({ platform, url, handle, icon }) => (
  <a
    ...
    className="flex items-center space-x-2 p-1 bg-slate-900/50 hover:bg-slate-700/50 border border-slate-700 rounded-lg transition-colors duration-200"
  >
    ...
    <div className="w-full">
      ...
      <div className="mt-2 flex justify-center">
          <img 
              ...
              className="w-20 h-20 object-cover rounded-full border-2 border-blue-500 shadow-lg shadow-blue-500/30 p-1 bg-slate-800" 
          />
      </div>
